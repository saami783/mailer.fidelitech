...
class ResetPasswordControllerTest extends WebTestCase
{
    ...
    public function testResetPasswordController(): void
    {
        ...
        // Submit the reset password form and test emails message is queued / sent
        $this->client->submitForm('Send password reset emails', [
            'reset_password_request_form[emails]' => 'me@example.com',
        ]);

        // Ensure the reset password emails was sent
        ...
        self::assertResponseRedirects('/reset-password/check-emails');

        // Test check emails landing page shows correct "expires at" time
        ...
        // Test the link sent in the emails is valid
        ...
        $user = $this->userRepository->findOneBy(['emails' => 'me@example.com']);
